...
<#
  extract_spa.ps1 — deliberately not a twin.
...
[Console]::Error.WriteLine("[spa-screen-extractor:python-required] extract_spa.ps1 is a stub: this check cannot be implemented in PowerShell.")
[Console]::Error.WriteLine("Run the Python original instead:")
[Console]::Error.WriteLine("  python tools/spa-screen-extractor/extract_spa.py --help")
exit 1
