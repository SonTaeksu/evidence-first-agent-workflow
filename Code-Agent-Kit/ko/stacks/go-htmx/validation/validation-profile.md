...
- Go Profile과 마찬가지로 Build, vet, Test. 모든 Exit Code를 기록합니다.
- Fragment: `HX-Request`를 실은 Request에 대해 반환된 Markup을 Assert합니다. 200은 Swap이 동작하리라는 Evidence가 아닙니다.
- 제공되는 Asset에서 읽은 HTMX Version을 기록합니다.
