# Stack-Specific Agent Rules — Rust
...
- Do not state a version-sensitive fact from memory. Do not mix documentation for different async runtimes; their types are not interchangeable. Do not answer from a pre-2018-edition source.
