...
|---|---|---|---:|---|
| `rust-book` | `https://gitmcp.io/rust-lang/book` | **PASS** | 4 | 공식 Book |
| `rust-reference` | `https://gitmcp.io/rust-lang/reference` | **PASS** | 4 | 공식 Reference |
...
용도: 개념과 관용적 표현 — 소유권, Borrowing, Error 처리.
...
용도: 정확한 언어 규칙 — 문법, Type, 표현식, Lifetime과 Trait Object 제약. Book은 설명하고, Reference는 판정합니다.
