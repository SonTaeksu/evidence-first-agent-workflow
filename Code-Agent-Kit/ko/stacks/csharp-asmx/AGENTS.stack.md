# Stack 전용 Agent Rule — ASMX Web Service 2.0 (.NET Framework 4+)
...
- Version에 민감한 Fact를 기억에서 꺼내 말하지 않습니다. ASMX 질문에 WCF나 ASP.NET Core 문서로 답하지 않습니다. Serializer도, Attribute Model도, Hosting Pipeline도 모두 다릅니다.
