...
| `asmx-docs` | `https://gitmcp.io/dotnet/AspNetDocs` | **PASS** | 4 | Legacy 문서 Repository |
...
용도: System.Web.Services, WebMethod, SoapHeader, XML 직렬화, SOAP 1.1과 1.2, WSDL, IIS Hosting.
...
용도: 특히 ASP.NET 4.x Page. ASMX에 대한 답을 ASP.NET Core에 대한 답과 떼어 놓는 방법이 이것입니다.
