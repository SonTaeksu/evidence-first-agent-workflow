# Stack-Specific Agent Rules — Node.js
...
- Do not state a version-sensitive fact from memory. Do not answer Node questions from browser JavaScript documentation. Do not assume a framework — a Node project need not have one.
