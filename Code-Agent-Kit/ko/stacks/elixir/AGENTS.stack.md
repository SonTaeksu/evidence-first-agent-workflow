# Stack-Specific Agent Rules — Elixir
...
- Do not state a version-sensitive fact from memory. Do not answer from a shared-mutable-state framework's documentation. Do not mix LiveView major-version guidance; the lifecycle changed.
