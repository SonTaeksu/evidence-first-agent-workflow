# Stack 전용 Agent Rule — WPF (.NET Framework 4.7.2+)
...
- 문서 조회는 `mcp/source-routing.md`를 통해 라우팅합니다. 이 Stack에서 권위 있는 Source는
  `microsoft-learn`이고 `context7`은 아닙니다. 이유는 그 문서에 적혀 있습니다.
...
- Version에 민감한 Fact를 기억으로 진술하지 않습니다. WPF 질문을 Package 문서 Server로 보내지 않습니다. WPF는 Package가 아니라 Framework의 일부입니다.
