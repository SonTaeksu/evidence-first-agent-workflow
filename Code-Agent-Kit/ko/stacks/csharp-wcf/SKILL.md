---
name: csharp-wcf
description: Use this skill when implementing or validating work in the WCF (.NET Framework 4.7.2+) stack.
---
...
| Anything version-sensitive | `references/verified-facts.md`, then look it up through `microsoft-learn` |
