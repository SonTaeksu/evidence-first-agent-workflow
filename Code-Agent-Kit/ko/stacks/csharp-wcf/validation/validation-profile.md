...
- Build: Project의 Target Framework에 대한 MSBuild. Exit Code가 판정입니다.
- Contract: Client를 다시 생성하고 Diff를 봅니다. 비어 있지 않은 Diff는 Wire Format 변경이며, 흡수하지 말고 보고해야 합니다.
- Test: Project의 Runner. 명령과 Exit Code를 기록합니다.
