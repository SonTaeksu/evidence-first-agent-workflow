...
Project의 Target Framework가 Source가 서술하는 Version과 다르면 **멈추고 불일치를 보고합니다**. 문서가 우연히 보여준 Version을 대상으로 구현하지 않습니다. 해결되지 않은 항목은 `⟨verification required: what and how⟩`로 기록합니다.
