# Stack-Specific Agent Rules — Next.js
...
- Do not state a version-sensitive fact from memory. Do not answer Next.js questions from generic React documentation where rendering, caching or routing is involved — the framework changes those. Do not mix App Router and Pages Router guidance.
