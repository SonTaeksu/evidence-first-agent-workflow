...
| `wpf-docs` | `https://gitmcp.io/dotnet/docs-desktop` | **PASS** | 4 | documentation repository, searched as source |
...
Use it for: WPF concepts, XAML, data binding, dependency properties, routed events, resources and styles, Dispatcher, deployment.
...
Use it for: the WPF and Windows Forms conceptual docs at source, including .NET Framework-era pages Learn search may not surface.
