...
<#
  extract_palette.ps1 — deliberately not a twin.
...
[Console]::Error.WriteLine("[reference-image-manifest:python-required] extract_palette.ps1 is a stub: this check cannot be implemented in PowerShell.")
[Console]::Error.WriteLine("Run the Python original instead:")
[Console]::Error.WriteLine("  python tools/reference-image-manifest/extract_palette.py --help")
exit 1
