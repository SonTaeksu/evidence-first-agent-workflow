# Roo Code and Zoo Code Adapter — binding rules

Roo Code and Zoo Code auto-load rules under `.roo/rules/`. The full, binding ruleset is `AGENTS.md` in the project root — read it and follow it; this adapter does not replace it. Non-negotiables, always in effect:
